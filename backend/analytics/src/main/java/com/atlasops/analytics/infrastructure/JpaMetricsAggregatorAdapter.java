 ...
 *
 * <p>Computes dashboard metrics via native JPQL/native queries against the main tables. Results are
 * not cached at this layer — caching can be added at the use case layer.
 *

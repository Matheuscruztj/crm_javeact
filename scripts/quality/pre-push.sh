...
run_quiet_or_fail "Backend fast verification failed" run_in_root ./gradlew --no-configuration-cache verifyFast
run_quiet_or_fail "Backend static analysis failed" run_in_root ./gradlew --no-configuration-cache checkstyleMain spotbugsMain
run_quiet_or_fail "Backend property tests failed" run_in_root ./gradlew --no-configuration-cache testProperty
run_quiet_or_fail "Backend architecture tests failed" run_in_root ./gradlew --no-configuration-cache :backend:app-boot:architectureTest

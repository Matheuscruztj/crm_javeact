...
run_quiet_or_fail "OpenAPI contract lint failed" run_in_root npx -y @stoplight/spectral-cli@6.15.0 lint backend/app-boot/build/reports/openapi/openapi.json --ruleset spectral:oas
